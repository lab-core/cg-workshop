...
\begin{frame}{Exercise E -- goal}
  \begin{exbox}[Exercise E -- arc-branching B\&P]
    ...
    \begin{itemize}\small
      ...
      \item \textbf{E.3}: two children -- forbid / force.
      \item \textbf{E.4}: in \texttt{pricing.py}, skip forbidden arcs at
            graph-build time.
    \end{itemize}
    The B\&P search loop is \alert{already coded}. The Lagrangian bound
    used for pruning was implemented in Exercise C (Trick~7).
  \end{exbox}
